...
bot.command("addkey", async (ctx) => {
  ...
  if (!args || !args.includes(",")) {
    return ctx.reply("✗ Akses hanya untuk Owner - tidak bisa sembarang orang bisa mengakses fitur ini\n\nExample :\n• /addkey DarkAgle,1d\n• /addkey DarkAngle,1d,aii", { parse_mode: "HTML" });
  }
...
app.get("/", (req, res) => {
  const filePath = path.join(__dirname, "INDICTIVE", "index.html");
...
*/
const BOT_TOKEN = "8465154707:AAHrapMYap_Ws9JQdUwE513SrDbbCWctEY0";
